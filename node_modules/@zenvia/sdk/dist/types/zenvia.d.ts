...
export { SmsChannel, RcsChannel, InstagramChannel, FacebookChannel, WhatsAppChannel, TextContent, FileContent, Template, PartialTemplate, LocationContent, ContactsContent, TemplateContent, MessageSubscription, MessageStatusSubscription, };
export declare type Channel = 'sms' | 'whatsapp' | 'facebook' | 'rcs' | 'instagram';
